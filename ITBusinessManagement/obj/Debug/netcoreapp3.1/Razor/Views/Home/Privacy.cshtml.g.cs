#pragma checksum "/Users/bdgstudio/Projects/ITBusinessManagement/ITBusinessManagement/Views/Home/Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "30254e00f08dbc62b0120857b77b5d60755b819e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"30254e00f08dbc62b0120857b77b5d60755b819e", @"/Views/Home/Privacy.cshtml")]
    ...
    <div class=""container-fluid mt-0"">
                        ...
                        <table>
                            <tr>
                                <td style=""height:auto"">
                                    ...
                                    <p>
                                        Biz, MSoftware, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile,
                                        hangi kişisel verilerinizin hangi amaçla işleneceği, işlenen verilerin kimlerle ve neden paylaşılabileceği,
                           ");
            WriteLiteral(@"             veri işleme yöntemimiz ve hukuki sebeplerimiz ile; işlenen verilerinize ilişkin haklarınızın neler olduğu
                                    ...
                                    <p>
                                        ...
                                        meşru me");
            WriteLiteral(@"nfaat işleme şartına dayanılarak işlenecektir.
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        yerine getirilebilmesi amacıyla, sözleşme ve hizmet süre");
            WriteLiteral(@"since, amacına uygun ve ölçülü bir şekilde
                                    ...
                                    <p>KVKK madde 11 uyarınca ");
            WriteLiteral(@"herkes, veri sorumlusuna başvurarak aşağıdaki haklarını kullanabilir:</p>
                                    <ol type=""a"">
      ...
      ");
            WriteLiteral(@"                                  <li>İşlenen verilerin münhasıran otomatik sistemler vasıtasıyla analiz edilmesi suretiyle kişinin kendisi aleyhine bir sonucun ortaya çıkmasına itiraz etme,</li>
                                    ...
                                    <p>Yukarıda sayılan haklarınızı kullanmak üzere info.msoftware.com üzerinden bizimle iletişime geçebilirsiniz.</p>
                                    <h2>İletişim</h2>
                                    <p>
                                        ...
                                        tamamen özgürsünüz. yi ku");
            WriteLiteral(@"llanmaya devam ettiğiniz takdirde kabul etmiş olduğunuz tarafımızca
                                        varsayılacak olup, daha ayrıntılı bilgi için bizimle info.msoftware.com.com e-mail adresi üzerinden iletişime
                                        geçmekten lütfen çekinmeyiniz.
                                    </p>


                                    <div class=""is-hidden"" id=""terms"">
                                        <h1>Kullanım Koşulları</h1>
                                        <p>Son güncellenme: 21/01/2021</p>
                                        <p>
                                            Sevgili ziyaretçimiz, lütfen ITBusinessManagement web mizi ziyaret etmeden önce işbu
                                            kullanım koşulları sözleşmesini dikkatlice okuyunuz. ye erişiminiz
                                            tamamen bu sözleşmeyi kabulünüze ve bu sözleşme ile belirlenen
                                            şartlara uymanıza bağlıdır. Şayet bu sözleş");
            WriteLiteral(@"mede yazan herhangi
                                            bir koşulu kabul etmiyorsanız, lütfen ye erişiminizi sonlandırınız.
                                            ye erişiminizi sürdürdüğünüz takdirde, koşulsuz ve kısıtlamasız olarak,
                                            işbu sözleşme metninin tamamını kabul ettiğinizin, tarafımızca varsayılacağını
                                            lütfen unutmayınız.
                                        </p>
                                        <p>
                                            ITBusinessManagement web si MSoftware tarafından yönetilmekte olup, bundan sonra SİTE olarak anılacaktır.
                                            İşbu ye ilişkin Kullanım Koşulları, yayınlanmakla yürürlüğe girer.
                        ...
                        ");
            WriteLiteral(@"                    tüm kullanıcılarımız baştan kabul etmiş sayılır.
                                        </p>
                                        <h2>Gizlilik</h2>
                                        <p>
                                        ...
                                        <p>
                                            ...
                                            çerçevesinde belirlemekte tamamen serbest olup; hizmetlere ilişkin yapacağım");
            WriteLiteral(@"ız
                                            değişiklikler, SİTE'de yayınlanmakla yürürlüğe girmiş sayılacaktır.
                                        </p>
                                        <h2>Telif Hakları</h2>
                                        <p>
                                            IT Business Management'da yayınlanan tüm metin, kod, grafikler,
                                            ...
                                            tüm hakları saklıdır. Yazılı izin olmaksızın IT Business Management içeriğinin çoğaltılması veya kopyalanması
                                            kesinlikle yasaktır.
                                        </p>
                                        ...
                                        <ul>
                                            <li>
  ");
            WriteLiteral(@"                                              Kullanıcıların tamamı, SİTE'yi yalnızca hukuka uygun ve şahsi
                                            ...
                                            <li>
                                                IT Business Management'da mevcut bilgilerin doğruluk ve güncelliğini sağl");
            WriteLiteral(@"amak için
                                            ...
                                            <li>
                                                IT Business Management'a üçüncü şahıslar tarafından işletilen ve içerikleri tarafımızca
                                                bilinmeyen diğer web lerine, uygulamalara ve platformlara köprüler
                                                (hyperlink) bulunabil");
            WriteLiteral(@"ir. SİTE, işlevsellik yalnızca bu lere ulaşımı
                                            ...
                                            <li>
                                  ");
            WriteLiteral(@"              IT Business Management'da sunulan hizmetlerde, kusur veya hata olmayacağına ya da
                                                kesintisiz hizmet verileceğine dair garanti vermemekteyiz. SİTE'ye ve
                                                nin hizmetlerine veya herhangi bir bölümüne olan erişiminizi önceden
                                                bildirmeksizin herhangi bir zamanda sonlandırabiliriz.
                                            </li>
                                        </ul>
                                        <h2>Sorumluluğun Sınırlandırılması</h2>
                                        <p>
                                            IT Business Management kullanımından doğan zararlara ilişkin sorumluluğumuz, kast ve ağır ihmal ile sınırlıdır.
                                            Sözleşmenin ihlalinden doğan zararlarda, talep edilebilecek toplam tazminat,
                                            öngörülebilir hasarlar ile sınırlıdır. Yukarıda b");
            WriteLiteral(@"ahsedilen sorumluluk sınırlamaları
                     ...
                     ");
            WriteLiteral(@"               <div class=""is-hidden"" id=""cookies"">
                                        <h1>Çerez Politikası</h1>
                                        <p>Son güncellenme: 21/01/2021</p>
                                        <p>
                                            Biz, MSoftware, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz
                                            sevgili ziyaretçilerimizi, web mizde hangi çerezleri, hangi amaçla kullandığımız
                                   ...
                                   ");
            WriteLiteral(@"         bu Çerez Politikasını okuyunuz. Daha fazla bilgi için Gizlilik Politikamıza göz atabilir ya da
                                            bizlerle çekinmeden iletişime geçebilirsiniz.
                                        </p>
                                        <h2>Çerez Nedir?</h2>
                                        <p>
                                            Çerezler, kullanıcıların web lerini daha verimli bir şekilde kullanabilmeleri adına,
                                        ...
                                        <p>
                              ");
            WriteLiteral(@"              Bizler de siz sevgili ziyaretçilerimizin, web mizden en verimli şekilde yararlanabilmelerini
                                        ...
                                        <p>
                                            Zorunlu çerezler, web sine ilişkin temel işlevleri etkinleştirerek
                                            web sinin kullanılabilir hale gelmesini sağlayan çerezlerdir. Web si
                                            bu çerezler olmadan düzgün çalışmaz.
                                        </p>
                                        <h3>2. Performans Çerezleri</h3>
                                        <p>
                                            Performans çerezleri, ziyaretçi");
            WriteLiteral(@"lerin web sine ilişkin kullanım bilgilerini
                                            ve tercihlerini anonim olarak toplayan ve bu sayede web sinin performansının
                                            geliştirilmesine olanak sağlayan çerezlerdir.
                                        </p>
                                        <h3>3. Fonksiyonel Çerezler</h3>
                                        <p>
                                            Fonksiyonel çerezler, kullanıcıların web sine ilişkin geçmiş kullanımlarından
                                            yola çıkılarak gelecekteki ziyaretlerinde tanınmalarını ve hatırlanmalarını sağlayan
                                            ve bu sayede web lerinin kullanıcılara dil, bölge vb. gibi kişiselleştirilmiş bir
                                            hizmet sunmasına olanak tanıyan çerezlerdir.
                                        </p>
                                        <h3>4. Reklam Çerezleri</h3>
                           ");
            WriteLiteral(@"             <p>
                                            Reklam çerezleri, üçüncü taraflara ait çerezlerdir ve web lerinde ziyaretçilerin
                                        ...
                                        <p>
                                            ...
                                            yöntemlerle ve bazen ");
            WriteLiteral(@"de analitik sağlayıcılar, reklam ağları, arama bilgi sağlayıcıları,
                                        ...
                                        <p>
                                            Web mizde, şüpheli eylemlerin tespiti yoluyla güvenliğin sağlanması, kullanıcıların
                           ...
                           ");
            WriteLiteral(@"                 sözleşmesel ve hukuki sorumlulukların yerine getirilmesi amaçlı çerezler kullanmaktadır.
                                        ...
                                        <p>
                                            ...
                                            ya da engelleyerek, web mize adım attığınız anda yönetebilir ya da gelecekte,
                                            istediğiniz zaman bu ayarları değiştirebilirsiniz. Daha");
            WriteLiteral(@" ayrıntılı bilgi için Gizlilik Politikamıza
                                            göz atabilir ya da bizlerle info.msoftware.com e-mail adresi üzerinden iletişime geçebilirsiniz.
                                        </p>
                                </td>
                            </tr>
                        </table>
